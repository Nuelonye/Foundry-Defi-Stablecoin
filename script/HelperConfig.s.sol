...
contract HelperConfig is Script {
    ...
    uint256 private constant AMOUNT = 1000e8;
    ...
    function getSepoliaNetworkConfig() public view returns (NetworkConfig memory) {
        return NetworkConfig({
            ...
            initialOwner: vm.addr(vm.envUint("SEPOLIA_PRIVATE_KEY"))
        });
    }
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        vm.startBroadcast();
        MockV3Aggregator wethMockPriceFeed = new MockV3Aggregator(DECIMAL, WETH_USD_PRICE);
        ERC20Mock wethMock = new ERC20Mock();

        MockV3Aggregator wbtcMockPriceFeed = new MockV3Aggregator(DECIMAL, WBTC_USD_PRICE);
        ...
        return NetworkConfig({
            ...
            initialOwner: vm.addr(DEFAULT_ANVIL_KEY)
        });
    }
}
