...
This project is a decentralized stablecoin where users can deposit WETH and WBTC as collateral for DSC token that will be pegged to the USD.
1. (Relative Stability) Anchored or Pegged -> $1.00
2. Stability Mechanism (Minting Method) Algorithmic
...
4 test tiers was used in this project.
